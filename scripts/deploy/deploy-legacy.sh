...
PLACEHOLDER_SEARCH_ZIP_PATH=${PLACEHOLDER_SEARCH_ZIP_PATH:-"../lambda-processing/warmreach-placeholder-search-prod/placeholder-search.zip"}
EDGE_PROCESSING_ZIP_PATH=${EDGE_PROCESSING_ZIP_PATH:-"../lambda-processing/warmreach-edge-processing-prod/edge-processing.zip"}
DYNAMODB_API_ZIP_PATH=${DYNAMODB_API_ZIP_PATH:-"../lambda-processing/warmreach-dynamodb-api-prod/dynamodb-api.zip"}
