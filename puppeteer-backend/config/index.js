...
export const config = {
  ...
  linkedinInteractions: {
    ...
    enableHumanBehavior: process.env.ENABLE_HUMAN_BEHAVIOR !== 'false', // Default true
    enableSuspiciousActivityDetection: process.env.ENABLE_SUSPICIOUS_ACTIVITY_DETECTION !== 'false', // Default true
